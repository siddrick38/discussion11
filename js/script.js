...
document.getElementById("host-name").innerHTML = "Layne Stephens";
document.getElementById("collaborator-name").innerHTML = "Siddarth Jalagam";

// Question 2
// You can also create their own CSS classes in style.css file and use that. 

// document.getElementById("instruction_button").addEventListener("click", hideInstructions);
